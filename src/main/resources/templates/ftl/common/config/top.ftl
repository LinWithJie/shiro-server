	           ...
	           <ul class="nav navbar-nav  pull-right" >
				<li class="dropdown ${(index==10)?string('active','')}" style="color:#fff;">
					<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown"  
						<@shiro.user>  
							onclick="location.href='${basePath}/index'" href="${basePath}/index" class="dropdown-toggle qqlogin" >
						...
						<@shiro.guest>   
							 href="javascript:void(0);" onclick="location.href='${basePath}/login'" class="dropdown-toggle qqlogin" >
